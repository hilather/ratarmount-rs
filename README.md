...
| | |
|--|--|
| **Version** | **0.1.6** ([releases](https://github.com/hilather/ratarmount-rs/releases)) |
...
| Dimension | Python (`mxmlnkn/ratarmount`) | Rust (`ratarmount-rs` 0.1.6) |
|-----------|------------------------------|------------------------------|
...
**Packages:** GitHub Actions builds Linux `.deb` / Rocky `.rpm` / portable glibc 2.31 tarballs **and macOS arm64 tarballs**, with cosign keyless signatures. Tag `v*` (e.g. **v0.1.6**) publishes a GitHub Release. (Intel macOS CI image deferred — scarce GHA runners.) See [`docs/packaging.md`](docs/packaging.md) and [`docs/macos.md`](docs/macos.md).
