...
- **Upstream bugs inspected (2026-07-28):** [`docs/tasks/upstream-bugs-inspection.md`](tasks/upstream-bugs-inspection.md) — 14 ok (incl. **B-2** recursive RAM documented: prefer `-l`/`--lazy` + `--recursion-depth`); residuals **B-4** union symlink policy, **B-10** GNU incremental delete merge, **B-8** optional 8 GiB sparse, **B-119** index-min-count
