...
| Union locate forwards `sources[0]` / drops later catalog | `cargo test -p ratarmount-compositing --lib search_cheap` (filters: `union_merges`, `union_empty`, `union_none_if_any`) |
